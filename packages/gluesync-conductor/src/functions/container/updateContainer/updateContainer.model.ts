...
export type UpdateContainerParams = Readonly<{
  id: string;
}>;
...
export type UpdateContainerResponse = SuccessResponse<any> | ErrorResponse;

export type UpdateContainerHandler = RouteHandlerMethod<
  any,
  any,
  any,
  {
