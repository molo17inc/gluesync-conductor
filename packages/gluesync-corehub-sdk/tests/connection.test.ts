...
describe('WebSocketConnection', () => {
  ...
  test('should handle connection errors', async () => {
    ...
    jest
      ...
      .mockRejectedValueOnce(new GluesyncConnectionError('Connection failed'));
  ...
  test('should handle timeouts', async () => {
    ...
    jest
      .spyOn(WebSocketConnection.prototype, 'connect')
      .mockRejectedValueOnce(new GluesyncTimeoutError('Connection timed out'));
